...
ffmpeg -f x11grab -video_size $resolution -y -i $DISPLAY -i $lock_image -filter_complex "boxblur=5:1,overlay=(main_w-overlay_w)/2:(main_h-overlay_h)/4" -vframes 1 $temp_background -loglevel quiet 
